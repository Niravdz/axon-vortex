  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        mono: ["var(--font-mono)", "Space Mono", "ui-monospace", "SFMono-Regular", "Menlo", "Monaco", "Consolas", "monospace"],
      },
      boxShadow: {
      ...
      letterSpacing: {
        hero: "var(--tracking-hero, 0.015em)",
        headline: "var(--tracking-heading, 0.02em)",
        button: "var(--tracking-button, 0.05em)",
        label: "var(--tracking-label, 0.06em)",
        mono: "var(--tracking-mono, 0.04em)",
        tighter: "-0.03em",
        tight: "-0.015em",
        normal: "0em",
        wide: "0.06em",
