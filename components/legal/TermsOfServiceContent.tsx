...
export default function TermsOfServiceContent() {
  return (
    ...
    >
      ...
      {/* 2. What we do */}
      <section id="sec-2" className="flex flex-col gap-4 border-b border-white/10 pb-8">
        <h2 className="text-2xl font-heading font-semibold text-[#EFECE4]">
          2. What we do
        </h2>
        <p className="text-sm text-[#9AA3B2] leading-relaxed">
      ...
      <section id="sec-13" className="flex flex-col gap-4 border-b border-white/10 pb-8">
        <h2 className="text-2xl font-heading font-semibold text-[#EFECE4]">
      ...
      <section id="sec-14" className="flex flex-col gap-4 border-b border-white/10 pb-8">
        <h2 className="text-2xl font-heading font-semibold text-[#EFECE4]">
          14. Governing law &amp; disputes
        </h2>
        <p className="text-sm text-[#9AA3B2] leading-relaxed">
      ...
      <section id="sec-15" className="flex flex-col gap-4 border-b border-white/10 pb-8">
        <h2 className="text-2xl font-heading font-semibold text-[#EFECE4]">
          15. Changes to these Terms
        </h2>
        <p className="text-sm text-[#9AA3B2] leading-relaxed">
      ...
      {/* 16. General */}
      <section id="sec-16" className="flex flex-col gap-4 border-b border-white/10 pb-8">
        <h2 className="text-2xl font-heading font-semibold text-[#EFECE4]">
          16. General
        </h2>
        <ul className="list-disc pl-6 space-y-1 text-sm text-[#9AA3B2] leading-relaxed">
          ...
          <li><strong className="text-[#EFECE4]">Assignment:</strong> You may not assign this agreement without our written consent.</li>
        </ul>
      </section>
