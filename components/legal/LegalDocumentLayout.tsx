...
export function LegalDocumentLayout({
  ...
  return (
    <div className="w-full bg-[#141619] text-[#EFECE4] selection:bg-[#3B82F6] selection:text-white min-h-screen">
      ...
      {/* 1. HERO BANNER */}
      <section className="pt-20 md:pt-24 pb-12 px-6 md:px-12 border-b border-white/[0.08] bg-[#141619]">
