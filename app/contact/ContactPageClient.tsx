        ...
        >
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            <div className="motion-left lg:col-span-5 flex flex-col gap-6">
              ...
              <div className="p-6 rounded-[16px] bg-[#141619] border border-white/[0.08] shadow-box-sm flex flex-col gap-3">
                ...
                <div className="flex flex-col gap-2 pt-2">
                  {notReadyToTalk.options.map((opt, idx) => (
                    <Link
                      key={idx}
                      href={opt.href}
                      className="flex items-center justify-between p-2 rounded-[8px] bg-[#101215] border border-white/[0.04] shadow-box-inset hover:border-[#3B82F6]/40 transition-colors text-xs font-mono text-[#EFECE4]"
                    >
                      <span>{opt.title}</span>
            ...
            <div className="motion-right lg:col-span-7">
